...
class MemberMetricDetailsRequest extends FormRequest
{
    use Authorize;
    ...
    public function rules(): array
    {
        return [
            ...
            'filter.month' => 'required|integer|digits_between:1,12',
            'filter.metric' => 'required|string|in:activeMembers,newMembers,deactivatedMembers',
        ];
    }
}
