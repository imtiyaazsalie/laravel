...
class CreatePaymentRequest extends FormRequest
{
    ...
    public function authorize(): Response|bool
    {
        return $this->canOperate(
            ...
            tenantId: $this->route('invoice')->invoice_location->tenant_id,
            locationId: $this->route('invoice')->invoice_location->getKey()
        );
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'tag_id' => ['sometimes', new TagRule('payment_processor')],
        ];
    }
}
