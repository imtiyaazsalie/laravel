...
class StagingEnvironmentSeeder extends Seeder
{
            ...
            [
                ...
                'locations' => [
                    [
                        'name' => 'Woodstock',
                        'categoryId' => 1,
                        'attendanceCode' => '1a73b793-6ca5-4e9a-9752-7b226a43d284',
                        'numberOfMembers' => 10,
                        'address' => [
                            'streetAddress' => '6 Beach Road',
                            'city' => 'Cape Town',
                            'stateProvinceRegion' => 'Western Cape',
                            'postalCode' => '7915',
                            'countryCode' => 'ZA',
                            'latitude' => '-33.92447694913734',
                            'longitude' => '18.448742377720343',
                        ],
                    ],
                    [
                        'name' => 'De Waterkant',
                        'categoryId' => 1,
                        'attendanceCode' => '68a5b9e0-4eab-4a5d-a57c-d7a5f4a746f5',
                        'numberOfMembers' => 10,
                        'address' => [
                            'streetAddress' => 'Corner Chiappini And Waterkant Street',
                            'city' => 'Cape Town',
                            'stateProvinceRegion' => 'Western Cape',
                            'postalCode' => '8001',
                            'countryCode' => 'ZA',
                            'latitude' => '-33.91497005596508',
                            'longitude' => '18.41852475889119',
                        ],
                    ],
                    [
                        'name' => 'Sea Point',
                        'categoryId' => 4,
                        'attendanceCode' => '940b0a10-9a3f-4f20-a58a-45ea5463d7c7',
                        'numberOfMembers' => 10,
                        'address' => [
                            ...
                            'postalCode' => '8060',
                            'countryCode' => 'ZA',
                            'latitude' => '-33.909699019902355',
                            'longitude' => '18.39174558503463',
                        ],
                    ],
                ],
            ],
            [
                ...
                'locations' => [
                    [
                        'name' => 'Woodstock',
                        'categoryId' => 2,
                        'attendanceCode' => 'f12ea58b-4621-4f13-aed3-95a3a4cc8839',
                        'numberOfMembers' => 10,
                        'address' => [
                            'streetAddress' => '145 Sir Lowry Road',
                            'city' => 'Cape Town',
                            'stateProvinceRegion' => 'Western Cape',
                            'postalCode' => '7915',
                            'countryCode' => 'ZA',
                            'latitude' => '-33.927135402231',
                            'longitude' => '18.439809115032755',
                        ],
                    ],
                    [
                        'name' => 'Kloof',
                        'categoryId' => 2,
                        'attendanceCode' => '57e2b505-7f0d-4b3d-932a-15b349c1a3d9',
                        'numberOfMembers' => 10,
                        'address' => [
                            'streetAddress' => '10 Jamieson Street',
                            'city' => 'Cape Town',
                            'stateProvinceRegion' => 'Western Cape',
                            'postalCode' => '8001',
                            'countryCode' => 'ZA',
                            'latitude' => '-33.9268122255658',
                            'longitude' => '18.41245072865317',
                        ],
                    ],
                    [
                        'name' => 'Camps Bay',
                        'categoryId' => 2,
                        'attendanceCode' => '89f3c572-5e90-46e5-b7c7-86b3a59ed6ed',
                        'numberOfMembers' => 10,
                        'address' => [
                            'streetAddress' => '75 Victoria Road',
                            'city' => 'Cape Town',
                            'stateProvinceRegion' => 'Western Cape',
                            'postalCode' => '8005',
                            'countryCode' => 'ZA',
                            'latitude' => '-33.95334648160038',
                            'longitude' => '18.37764678215943',
                        ],
                    ],
                ],
            ],
            [
                ...
                'locations' => [
                    [
                        'name' => 'Claremont',
                        'categoryId' => 1,
                        'attendanceCode' => '75b1fc2c-9b3b-461a-9768-f6e21ec2bd81',
                        'numberOfMembers' => 10,
                        'address' => [
                            'streetAddress' => 'Library Square, Wilderness Road',
                            'city' => 'Cape Town',
                            'stateProvinceRegion' => 'Western Cape',
                            'postalCode' => '7780',
                            'countryCode' => 'ZA',
                            'latitude' => '-33.98548295629659',
                            'longitude' => '18.46805022463',
                        ],
                    ],
                    [
                        'name' => 'Tableview',
                        'categoryId' => 1,
                        'attendanceCode' => '84811088-fc46-4839-a629-b3523f9ed89a',
                        'numberOfMembers' => 10,
                        'address' => [
                            'streetAddress' => '85 Arum Road',
                            'city' => 'Cape Town',
                            'stateProvinceRegion' => 'Western Cape',
                            'postalCode' => '7441',
                            'countryCode' => 'ZA',
                            'latitude' => '-33.82386245204535',
                            'longitude' => '18.491016598760158',
                        ],
                    ],
                    [
                        'name' => 'Plattekloof',
                        'categoryId' => 1,
                        'attendanceCode' => '02c2bde1-8ce1-490a-abaa-688ccdf36be3',
                        'numberOfMembers' => 10,
                        'address' => [
                            'streetAddress' => 'Shop 6 Panorama Healthcare Centre Ctr, 43 Hennie Winterbach Street',
                            'city' => 'Cape Town',
                            'stateProvinceRegion' => 'Western Cape',
                            'postalCode' => '7500',
                            'countryCode' => 'ZA',
                            'latitude' => '-33.877010089657794',
                            'longitude' => '18.576883729445594',
                        ],
                    ],
                ],
            ],
    ...
    private function createUsersWithMoreThanOneUTB(): void
    {
        $tenantService = new TenantUserService();

        $tenantOne = Tenant::find(1);
        $tenantTwo = Tenant::find(2);
        $tenantThree = Tenant::find(3);

        // Get all the members for the first box
        $tenantUsers = $tenantService->getTenantUsersBy($tenantOne, [UserType::GYM_MEMBER]);

        // Create membership for user at box two
        $tenantService->createGymMemberBoxMembership($tenantUsers[0]->user, UserType::GYM_MEMBER, [
            'programme_id' => $tenantTwo->programmes->random()->getKey(),
            'package_id' => $tenantTwo->packages->random()->getKey(),
            'package_start_date' => Carbon::today()->subDays(rand(0, 365)),
            'payment_details' => [
        ...
        ], $tenantTwo, $tenantTwo->locations->first());

        // Create membership for user at box three
        //        $tenantService->createGymMemberBoxMembership($tenantUsers[1]->user, UserType::GYM_MEMBER, [
        //            'programme_id' => $tenantThree->programmes->random()->getKey(),
        //            'package_id' => $tenantThree->packages->random()->getKey(),
        //            'package_start_date' => Carbon::today()->subDays(rand(0, 365)),
        //            'payment_details' => [
        //                'user_debit_status_id' => UserDebitStatus::CASH,
        //                'invoicing_type' => 'facilityInvoicing',
        ...
        //                'end_date' => today()->addYear(),
        //            ],
        //        ], $tenantThree, $tenantThree->locations->first());
    }
}
